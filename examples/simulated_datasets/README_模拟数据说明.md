...
> bug 而误报 Item01，现已修复（见第 3 节与 `docs/待修问题清单.md` P1-11）。
...
>    真实原因是"整列全缺失"被 `read.csv` 读成了逻辑型，而且列名占位符打不出来（见 `待修问题清单.md` P1-12）。
>
...
*以上三条的详细复现与验收标准见 `docs/待修问题清单.md` 的 P1-11 / P1-12 / P1-13。*
